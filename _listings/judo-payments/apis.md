...
created: "2018-08-25"
modified: "2018-08-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/api-provider/master/_listings/judo-payments/apis.md
specificationVersion: "0.14"
apis:
- name: Judo Payments
  x-api-slug: judo-payments
  description: Judopay  Next generation mobile payments for an app experience your
    customers will love
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/2173-judo-payments.jpg
  humanURL: https://www.judopay.com/
  baseURL: https:///
  tags: API Provider
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/api-provider/master/_listings/judo-payments/openapi.md
x-common:
- type: x-crunchbase
