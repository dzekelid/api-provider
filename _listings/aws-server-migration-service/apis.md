...
created: "2018-08-25"
modified: "2018-08-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/api-provider/master/_listings/aws-server-migration-service/apis.md
...
- name: AWS Server Migration Service API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/api-provider/master/_listings/aws-server-migration-service/openapi.md
x-common:
- type: x-api-gallery
