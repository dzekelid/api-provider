...
created: "2018-08-25"
modified: "2018-08-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/api-provider/master/_listings/braintree/apis.md
specificationVersion: "0.14"
apis:
- name: Braintree
  x-api-slug: braintree
  description: An all-in-one solution to accept, process, and split payments in your
    mobile app or online -- from small business to large enterprise.
  image: http://kinlane-productions.s3.amazonaws.com/screen-capture-api/163-braintree.jpg
  humanURL: https://www.braintreepayments.com
  baseURL: https:///
  tags: API Provider
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/api-provider/master/_listings/braintree/openapi.md
x-common:
- type: x-blog
